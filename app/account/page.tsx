...
export default function AccountPage() {
  ...
  const saveProfile = async (event: FormEvent) => {
    ...
    if (!/^[A-Za-z0-9_.-]{3,24}$/.test(username)) { setError('Usa entre 3 y 24 letras, números, puntos, guiones o guiones bajos.'); setSaving(false); return; }
  ...
  const deleteAccount = async () => {
    ...
    const confirmation = prompt('Escribe ELIMINAR para confirmar.'); if (confirmation !== 'ELIMINAR') return;

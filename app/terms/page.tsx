...
export default function TermsPage() {
  return <main className="min-h-screen bg-[#07080d] px-5 py-16 text-zinc-200"><article className="mx-auto max-w-3xl space-y-6">
    ...
    <p>Al usar TypeTheLyrics aceptas estas reglas. El juego se ofrece para entretenimiento y aprendizaje de mecanografía; puede cambiar, interrumpirse o contener errores.</p>
    <h2 className="text-2xl font-bold text-white">Cuenta y conducta</h2>
    <p>Eres responsable de tu cuenta. No está permitido intentar acceder a cuentas o funciones administrativas, automatizar partidas, alterar puntuaciones, acosar a otros jugadores ni abusar de Spotify, LRCLIB o Supabase. Podemos limitar o suspender cuentas que incumplan estas reglas.</p>
    ...
    <p>Para reportar contenido, problemas o una posible infracción, usa el reporte del juego o el <a className="text-violet-300 underline" href="https://discord.gg/vWBs6txYZR" target="_blank" rel="noreferrer">Discord oficial</a>, indicando la canción y el motivo.</p>
